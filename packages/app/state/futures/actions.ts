...
import { ZERO_ADDRESS } from 'kwenta-sdk/constants/global';
import { NetworkId } from 'kwenta-sdk/types/common';
...
export const calculateCrossMarginFees = (params: TradePreviewParams): AppThunk => (
	dispatch,
	getState
) => {
	const markets = selectMarkets(getState());
